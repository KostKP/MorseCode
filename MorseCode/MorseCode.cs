...
namespace MorseCode
{
    public static class MorseCode
    {
        ...
        private static Dictionary<char, string> intl = new Dictionary<char, string>
            {
                {'1', "*----"},
                {'2', "**---"},
                {'3', "***--"},
        ...
        private static Dictionary<char, string> en = new Dictionary<char, string>
            {
                {'A', "*-"},
                {'B', "-***"},
                {'C', "-*-*"},
        ...
        private static Dictionary<char, string> ru = new Dictionary<char, string>
            {
                {'А', "*-"},
                {'Б', "-***"},
                {'В', "*--"},
